...
from PreprocessAssistment import PreprocessAssistmentPFASingleSkill
...
pfa.fit_single_skill(train, test, len(np.unique(data['user_id'])), len(np.unique(data['skill_id'])))
